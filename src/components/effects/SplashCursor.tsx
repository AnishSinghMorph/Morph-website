...
// Splash Cursor — reactbits.dev "Splash Cursor" (WebGL fluid simulation,
// after Pavel Dobryakov's WebGL-Fluid-Simulation), ported to TS.
// Configured per the requested params: COLOR #ca8650, DENSITY_DISSIPATION 6,
// VELOCITY_DISSIPATION 1, PRESSURE 0.4. Fixed full-screen, pointer-events none,
...
export function SplashCursor({
  ...
  TRANSPARENT = true,
  // #ca8650 → 0..1, scaled down for intensity
  SPLAT_COLOR = { r: 0.792, g: 0.525, b: 0.314 },
}: SplashCursorProps) {
  ...
  useEffect(() => {
    ...
    function generateColor() {
      // Tint around the requested COLOR (#ca8650) with subtle variation.
    ...
    const onTouchEnd = (e: TouchEvent) => {
      ...
      const pointer = pointers[0];
      for (let i = 0; i < touches.length; i++) void touches[i];
      pointer.down = false;
    };
    ...
    window.addEventListener("touchstart", onFirstTouchStart);
